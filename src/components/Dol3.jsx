...
import NoiseDol3 from '../models/NoiseDol3';
...
export default function Dol3({ nextPath, title }) {
  ...
  return (
    <DolContainer>
      <SoundControlContainer>
        <Player url={'assets/sound/sound3.mp3'} />
      </SoundControlContainer>
      <Canvas
        ...
        style={{
          height: '100%',
          backgroundImage: 'url(assets/imgs/noise3.jpg',
