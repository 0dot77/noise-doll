...
import NoiseDol4 from '../models/NoiseDol4';
...
export default function Dol4({ nextPath, title }) {
  ...
  return (
    <DolContainer>
      <SoundControlContainer>
        <Player url={'assets/sound/sound4.mp3'} />
      </SoundControlContainer>
      <Canvas
        ...
        style={{
          height: '100%',
          backgroundImage: 'url(assets/imgs/noise4.jpg',
