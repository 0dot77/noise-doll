...
import NoiseDol5 from '../models/NoiseDol5';
...
export default function Dol5({ nextPath, title }) {
  ...
  return (
    <DolContainer>
      <SoundControlContainer>
        <Player url={'assets/sound/sound5.mp3'} />
      </SoundControlContainer>
      <Canvas
        ...
        style={{
          height: '100%',
          backgroundImage: 'url(assets/imgs/noise5.jpg',
